...
export const Footer = () => {
  const programLinks = [
    { label: 'Explorer Day', href: '/students/explorer-day' },
    { label: 'Student Board', href: '/students/leadership-board' },
    { label: 'Media Internship', href: '/students/media-internship' },
    { label: 'Summer Internship', href: '/students/summer-internship' },
  ];

  const resourceLinks = [
    { label: 'Newsroom', href: '#newsroom' }, // Pending Kristen’s destination
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/shetechexplorer/',
      icon: (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/she.tech/?hl=en',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@WomenTechCncl',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
